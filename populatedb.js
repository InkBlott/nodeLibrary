...
console.log('This script populates some test books, authors, genres and bookinstances to your database. Specified database as argument - e.g.: populatedb mongodb+srv://user:password@cluster0.a9azn.mongodb.net/local_library?retryWrites=true');
